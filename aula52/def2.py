...
def divisao(n1, n2):
    if n2 == 0:       # divisões por zero resultam em erro, para isso, uma solução é checar antes, desse modo, é possivel inserir dois returns na mesa função
        return
    return n1 / n2    # pode-se tambem retornar a variavel com alguma ação
